        ...
        foreach ($columns as $col) {
            ...
            foreach ($col["cards"] ?? [] as $card) {
                ...
                $cards[] = [
                    ...
                    "title" => substr(
                        strip_tags((string) ($card["title"] ?? "")),
                        0,
                        120,
                    ),
                    "desc" => $desc,
                    "ref" => substr(
                        strip_tags((string) ($card["ref"] ?? "")),
                        0,
                        160,
                    ),
                    "tag" => substr(
                    ...
                    "revision" => substr(
                        strip_tags((string) ($card["revision"] ?? "")),
                        0,
                        500,
                    ),
            ...
            $clean[] = [
                "id" => substr(
                    preg_replace("/[^\w\-]/", "", (string) ($col["id"] ?? "")),
                    0,
                    64,
                ),
                "title" => substr(
                    strip_tags((string) ($col["title"] ?? "")),
                    0,
                    80,
                ),
                "cards" => $cards,
